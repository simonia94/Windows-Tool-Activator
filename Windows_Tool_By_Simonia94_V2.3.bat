...
:choix
title Windows Tools By Simonia94
ECHO.
ECHO 1. Activation de Windows 10 ( HWID )
ECHO 2. Activation de Windows 10 ( KMS38 )
ECHO 3. Mise a niveau d'édition Windows 10
ECHO 4. Outils D'activation de Windows/Office ( KMS )
ECHO 5. Activation de Windows 7 ( OEM )
ECHO 6. Verifier l'etat d'activation Windows ( VBS )
ECHO 7. Sortie
ECHO.
...
if '%choice%'=='1' goto activation-choix
if '%choice%'=='2' goto kms38-choix
if '%choice%'=='3' goto converti
if '%choice%'=='4' goto kms
if '%choice%'=='5' goto activation-w7-choix
if '%choice%'=='6' goto casVm
if '%choice%'=='7' goto fin
if '%choice%'=='8' goto 
if '%choice%'=='9' goto 
ECHO "%choice%" n'est pas valide, essayez ¨¤ nouveau
ECHO.
goto choix

:activation-choix
title Activator By Simonia94
ECHO.
ECHO Voulez-vous activer Windows 10 ?
ECHO ============================================================
ECHO 1. Oui
ECHO 2. Non
ECHO ============================================================
...
ECHO.
ECHO ============================================================
ECHO En cours d'activation Windows 10
ECHO ============================================================
ECHO.
...
:converti
title Windows 10 Convertiseur By Simonia94
ECHO.
ECHO 1. Professionel
ECHO 2. Famille
ECHO 3. Entreprise 
...
if '%choice%'=='5' goto choix
if '%choice%'=='6' goto fin
ECHO "%choice%" n'est pas valide, essayez ¨¤ nouveau
ECHO.
goto converti
...
echo.
echo ============================================================
echo En cours de mise a niveau d'edition Windows
echo ============================================================
echo.
...
title Activator By Simonia94
ECHO.
ECHO Voulez-vous activer Windows 7 ?
ECHO ============================================================
ECHO 1. Oui
ECHO 2. Non
ECHO ============================================================
...
set /p choice=Entrez votre choix :
if not '%choice%'=='' set choice=%choice:~0,1%
if '%choice%'=='1' goto activation-w7
if '%choice%'=='2' goto choix
ECHO "%choice%" n'est pas valide, essayez ¨¤ nouveau
ECHO.
goto choix
...
echo.
echo ============================================================
echo En cours d'activation Windows 7
echo ============================================================
echo.
...
:casVm
title V¨¦rifier l'¨¦tat d'activation By Simonia94
setlocal EnableDelayedExpansion
set _sO16vbs=0
set _sO15vbs=0
...
color 07
set "_title=Activator By Simonia94 %uivr%"
title %_title%
set _dMode=Manual
set _ReAR=0
set _AUR=0
...
echo.
if %_AUR% EQU 1 (           
call :Cfgbg %_cWht% "               [2] Activation de l'installation - Renouvellement automatique " %_cGrn% "[%_dHook%]"
) else (
echo                [2] Activation de l'installation - Renouvellement automatique
)
...
call :Cfgbg %_cWht% "               [4] Activer le mode debogage       " %_cRed% "[%_dDbg%]"
)
if %_dAwin%==Yes (
echo                [5] Processus Windows         [%_dAwin%]
) else (
call :Cfgbg %_cWht% "               [5] Processus Windows         " %_cYel% "[%_dAwin%]"
)
if %_dAoff%==Yes (
echo                [6] Processus Office          [%_dAoff%]
) else (
call :Cfgbg %_cWht% "               [6] Processus Office          " %_cYel% "[%_dAoff%]"
)
if %_dArtv%==Yes (
echo                [7] Convertir Office C2R-R2V  [%_dArtv%]
) else (
call :Cfgbg %_cWht% "               [7] Convertir Office C2R-R2V  " %_cYel% "[%_dArtv%]"
)
...
echo                    Miscellaneous:
echo.
echo                [8] Verifier l'etat d'activation [vbs]
echo                [9] Verifier l'etat d'activation [wmic]
echo                [S] Creer le dossier $OEM
echo                [R] Read Me
echo                [E] Activation [Mode externe]
echo           %line3%
echo.
if %winbuild% LSS 10586 (
popd
)
choice /c 1234567890ERSX /n /m ">           Choisissez une option de menu ou appuyez sur 0 pour quitter: "
set _el=%errorlevel%
...
set kip=
echo.
echo Entrez / Collez l'adresse du serveur KMS externe, ou appuyez simplement sur Entr¨¦e pour revenir:
echo.
set /p kip=
